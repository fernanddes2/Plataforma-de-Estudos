    ...
    <div className="p-8 2xl:p-12 max-w-screen-2xl 2xl:max-w-[1800px] mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 2xl:gap-12 mb-8">
                ...
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={stats.topicPerformance} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                        ...
                        <YAxis 
                            ...
                            type="category" 
                            width={140} 
                            tick={{ fontSize: 13, fill: '#64748b' }} // Slate-500
        ...
        <div className="space-y-6 2xl:space-y-8">
            <div className="bg-gradient-to-br from-secondary-900 to-slate-800 rounded-2xl p-8 2xl:p-10 text-white shadow-lg relative overflow-hidden h-full flex flex-col justify-center">
                <div className="relative z-10">
                    <h3 className="text-2xl 2xl:text-3xl font-bold mb-2">Continue Estudando</h3>
                    <p className="text-gray-300 mb-6 2xl:mb-8 max-w-md 2xl:text-lg">Você parou em Circuitos Elétricos. Que tal resolver mais algumas questões para manter o ritmo?</p>
                    <button 
